    ...
    static public class Generate
    {
        ...
        static public void x34(string dir = "C:", int workspaces = 4, int testspaces = 4, int tests = 4, bool regen = false)
        {
            ...
            else
            {
                ...
                File.WriteAllLines(dir + @"\x34-Core\per", gettree(dir));
            }
        }
        static public void workspace(string dir = @"C:\x34-Files\Workspaces\",int num = 1,int testspaces = 4, int tests = 4)
        {
        ...
        static public void testspace(string dir = @"C:\x34-Files\Workspaces\Workspace",int num = 1, int tests = 4)
        {
